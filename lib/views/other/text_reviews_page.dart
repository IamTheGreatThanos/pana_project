                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text('ball: ${displayedReviews[i].ball}'),
                                Text('staff: ${displayedReviews[i].staff}'),
                                Text('purity: ${displayedReviews[i].purity}'),
                                Text('price: ${displayedReviews[i].price}'),
                                Text('atmos: ${displayedReviews[i].price}'),
                              ],
                            ),
                          ),
                        )
