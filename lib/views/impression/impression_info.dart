...
class _ImpressionInfoState extends State<ImpressionInfo> {
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      for (var item in (thisImpression.provideItems ?? []))
                        Padding(
                          padding: const EdgeInsets.only(
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: MediaQuery.of(context).size.width * 0.9,
                    child: Text(
                      thisImpression.meetingPlaceLocationId?.description ?? '',
                      style: const TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.w500,
                          color: Colors.black45),
  ...
  void getTextReviews() async {
    textReviews = [];
    var response =
        await MainProvider().getTextReviewsInImpression(widget.impression.id!);
    if (response['response_status'] == 'ok') {
  ...
  void getAudioReviews() async {
    audioReviews = [];
    var response =
        await MainProvider().getAudioReviewsInImpression(widget.impression.id!);
    if (response['response_status'] == 'ok') {
      for (var item in response['data']) {
